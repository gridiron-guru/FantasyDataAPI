...
namespace FantasyDataAPI\Enum\FantasyDefenseSeason;
...
class Property
{
    ...
    const KEY_QUARTERBACK_FANTASY_POINTS_ALLOWED = 'QuarterbackFantasyPointsAllowed';
    const KEY_RUNNINGBACK_FANTASY_POINTS_ALLOWED = 'RunningbackFantasyPointsAllowed';
    ...
    const KEY_KICKER_FANTASY_POINTS_ALLOWED = 'KickerFantasyPointsAllowed';
