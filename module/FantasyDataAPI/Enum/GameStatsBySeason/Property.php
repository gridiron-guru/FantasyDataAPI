...
namespace FantasyDataAPI\Enum\GameStatsBySeason;
...
class Property
{
    ...
    const KEY_AWAY_TWO_POINT_CONVERSION_RETURNS = 'AwayTwoPointConversionReturns';
    const KEY_HOME_TWO_POINT_CONVERSION_RETURNS = 'HomeTwoPointConversionReturns';
}