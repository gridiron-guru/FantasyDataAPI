...
namespace FantasyDataAPI\Test\NewsByPlayerID\Response;
...
class Mock extends Response
{
    ...
    {
        /** url parsing "formula" */
        list(, $subscription, $format, , $player_id) = explode( '/', $pRequest->getPath() );

        $file_partial = __DIR__ . '/' . implode('.', [$subscription, $format, $player_id]);
