...
class NewsByPlayerIDTest extends PHPUnit_Framework_TestCase
{

    /**
     * Given: A developer API key
     * When: API is queried for NewsByPlayerID
    ...
    public function testSuccessfulResponse()
    {
        ...
        $result = $client->NewsByPlayerID(['PlayerID' => '14257']);
    ...
    public function testInvalidAPIKey()
    {
        ...
        /** @var \GuzzleHttp\Command\Model $result */
        $client->NewsByPlayerID(['PlayerID' => '14257']);
    }
}
