...
namespace FantasyDataAPI\Test\PlayerGameStatsByWeek;
...
class UnitTest extends PHPUnit_Framework_TestCase
{
     ...
     *   http://api.nfldata.apiphany.com/developer/json/PlayerGameStatsByWeek/2013REG/17?key=000aaaa0-a00a-0000-0a0a-aa0a00000000
     */
    public static function setUpBeforeClass()
    {
        ...
        static::$sClient->PlayerGameStatsByWeek(['Season' => '2013REG', 'Week' => '17']);
     ...
     * When: API is queried for 2013REG, Week 17, PlayerGameStatsByWeek
     ...
     * Given: A developer API key
     * When: API is queried for 2013REG, Week 17, PlayerGameStatsByWeek
     * Then: Expect that the PlayerGameStatsByWeek resource is placed in the URI
     *
     * @group Unit
     * @small
     */
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( static::$sUrlFragments[6], 'PlayerGameStatsByWeek');
    }
    ...
    /**
     * Given: A developer API key
     * When: API is queried for 2013REG, Week 18, PlayerGameStatsByWeek
