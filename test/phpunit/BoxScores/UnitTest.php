...
namespace FantasyDataAPI\Test\BoxScores;
...
class UnitTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        static::$sClient->BoxScores(['Season' => '2013REG', 'Week' => '17']);
     ...
     * When: API is queried for 2013REG, Week 17, Team NE BoxScores
    ...
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( static::$sUrlFragments[5], 'BoxScores');
    }
