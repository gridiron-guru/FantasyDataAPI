...
namespace FantasyDataAPI\Test\Player;
...
class UnitTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        static::$sClient->Player(['PlayerID' => '10974']);
     ...
     * Given: A developer API key
     * When: API is queried for Rob Gronkowski (PlayerID: 10974)
     * Then: Expect that the Player resource is placed in the URI
     *
     * @group Unit
     * @small
     */
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( static::$sUrlFragments[6], 'Player');
    }
    ...
    public function testPlayerIDInURI()
    {
        ...
        list($player_id) = explode('?', static::$sUrlFragments[7]);
