...
namespace FantasyDataAPI\Test\FinalBoxScores;
...
class UnitTest extends PHPUnit_Framework_TestCase
{
     ...
     *   http://api.nfldata.apiphany.com/developer/json/FinalBoxScores?key=000aaaa0-a00a-0000-0a0a-aa0a00000000
     */
     ...
     * When: API is queried for FinalBoxScores
    ...
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( $resource, 'FinalBoxScores');
    }
