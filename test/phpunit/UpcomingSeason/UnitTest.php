...
class UnitTest extends PHPUnit_Framework_TestCase
{
     ...
     *   http://api.nfldata.apiphany.com/developer/xml/UpcomingSeason
     */
    ...
    /**
     * Given: A developer API key
     * When: API is queried for UpcomingSeason
     * Then: Expect that the UpcomingSeason resource is placed in the URI
     *
     * @group Unit
     * @small
     */
    public function testResourceInURI()
    {
        ...
        /** the last piece in the array should be UpcomingSeason so we need to snip that part off */
        list( $resource ) = explode( '?', static::$sUrlFragments[6] );

        $this->assertEquals($resource, 'UpcomingSeason');
    }
