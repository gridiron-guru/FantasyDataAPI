...
class UnitTest extends PHPUnit_Framework_TestCase
{
     ...
     *   http://api.nfldata.apiphany.com/developer/json/Stadiums?key=000aaaa0-a00a-0000-0a0a-aa0a00000000
     */
     ...
     * Given: A developer API key
     * When: API is queried for Stadiums
     * Then: Expect that the Stadiums resource is placed in the URI
     *
     * @group Unit
     * @small
     */
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( $resource, 'Stadiums');
    }
