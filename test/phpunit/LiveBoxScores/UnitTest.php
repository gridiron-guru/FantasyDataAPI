...
class UnitTest extends PHPUnit_Framework_TestCase
{
     ...
     *   http://api.nfldata.apiphany.com/developer/json/LiveBoxScores?key=000aaaa0-a00a-0000-0a0a-aa0a00000000
     */
    ...
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( $resource, 'LiveBoxScores');
    }
