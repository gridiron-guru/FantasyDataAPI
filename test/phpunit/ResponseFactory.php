...
class ResponseFactory
{
    public static function GetResponse( TransactionInterface $trans )
    {
        ...
        switch ( $resource )
        {
            ...
            case 'FantasyDefenseProjectionsByGame':
                $response = new FantasyDefenseProjectionsByGame\Response\Mock( $request );
                break;
            ...
            case 'GameStatsByWeek':
                $response = new GameStatsByWeek\Response\Mock( $request );
                break;
