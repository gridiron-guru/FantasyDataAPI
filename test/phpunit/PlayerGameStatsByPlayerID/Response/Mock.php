...
namespace FantasyDataAPI\Test\PlayerGameStatsByPlayerID\Response;
...
class Mock extends Response
{
    ...
    public function __construct (RequestInterface $pRequest)
    {
        ...
        list(, $subscription, $format, , $season, $week, $player_id) = explode( '/', $pRequest->getPath() );

        $file_partial = __DIR__ . '/' . implode('.', [$subscription, $format, $season, $week, $player_id]);
